/*
 *      Copyright (C) 2016 Tao Mo
 *      http://www.mxhaudio.com/
 *
...
{
  static const char *strBackendName = "china telecom iptv backend add-on";
...
{
  snprintf(signalStatus.strAdapterName, sizeof(signalStatus.strAdapterName), "ctc iptv adapter 1");
